      ...
      <div id="desktop-fix" className="position-realtive d-none d-md-block">
        <div className="container">
          <div className="d-flex=column justify-content-end mb-2 position-fixed custom">
            ...
            <div className="my-5">
              <a
                href="https://wa.me/918147203771?text='Hi! I'm Interested In Pre-Launch Projects, Bangalore. Please Share Details.'"
                target="_blank"
                className="bg-primary p-3 rounded-circle m-2"
              >
                <i
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-6 bg-primary p-3">
              <div className="text-center">
                <a
                  href="https://wa.me/918147203771?text='Hi! I'm Interested In Pre-Launching Projects, Bangalore. Please Share Details.'"
                  target="_blank"
