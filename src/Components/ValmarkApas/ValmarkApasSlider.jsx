            ...
            <Row className="">
              <Col md={8} className="">
                <div className="m-1 text-center text-md-start">
                  <h4>Avalon Park @ The Prestige City</h4>
                  <p className="m-0 text-center text-md-start">
                    <p className="mb-0 text-center text-md-start">Sarjapur Main Road, Bangalore</p>
...
export default ValmarkApasSlider
